        ...
        <div className="space-y-4 max-w-2xl">
          <div className={cardCls}>
            ...
            <p className="text-sm text-slate-400 mb-4">
              เมื่อพนักงานคนใดเปิดดูแชทที่ยังไม่ได้ตอบ ระบบจะเริ่มนับเวลาของคนนั้นเอง (แต่ละคนมีเวลานับแยกกันไปตามเวลาที่ตัวเองเปิดดู) —
              ถ้ามีพนักงานคนใดคนหนึ่งในบรรดาผู้ที่เปิดดูแชทนั้นตอบกลับก่อนเวลาของ<b>ตัวเอง</b>หมดลง ทุกคนที่เปิดดูแชทนั้น (รวมถึงคนที่เวลาของตัวเองหมดไปแล้วก็ตาม)
              จะไม่โดนนับว่า "อ่านแล้วไม่ตอบ" ในรายงานพนักงาน (เพราะลูกค้าได้รับการตอบแล้วจริง) —
              แต่ถ้าเวลาของทุกคนที่เปิดดูหมดลงแล้วยังไม่มีใครตอบเลย ทุกคนที่เปิดดูแชทนั้นจะถูกนับในรายงานตามเดิม
            </p>
            {agent?.role === 'admin' ? (
